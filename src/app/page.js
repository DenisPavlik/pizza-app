    ...
    <>
      ...
      <section className="text-center my-16" id="about">
        ...
        <div className="text-gray-500 max-w-2xl mx-auto mt-4 flex flex-col gap-4">
          <p>
            In 1985, Geronimo&apos;s pizza opened its doors for the very first time in Plano,
            Texas – and just like that, the Original home of all the pizza,
            pasta, salad, and desserts you can eat was born. For nearly four
            decades, Geronimo&apos;s pizza has been committed to creating fun, family-friendly
          ...
          <p>
            ...
            recent years, Geronimo&apos;s pizza put a stronger focus on its off-premise options
            with the launch of online ordering, and new menu items. Now, fans
            can easily order their favorites for pick-up or delivery at Geronimo&apos;s pizza
